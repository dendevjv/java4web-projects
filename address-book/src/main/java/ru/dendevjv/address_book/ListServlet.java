package ru.dendevjv.address_book;
...
public class ListServlet extends HttpServlet {
    ...
    static {
        contacts.add(new Contact("Jane", "Sanders", "555-1593",
                "394 E 22nd Ave", MonthDay.of(Month.JANUARY, 5), Instant
                        .parse("2013-02-01T15:22:23Z")));
        ...
        contacts.add(new Contact("Scott", "Johnson", "555-9834", "424 Oak Dr",
                MonthDay.of(Month.NOVEMBER, 17), Instant
                        .parse("2013-04-04T19:45:01Z")));
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        /* Change the language the page displays in. */
